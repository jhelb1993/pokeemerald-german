...
const u8 gEasyChatWord_Sweets[] = _("NASCHEN");
...
const u8 gEasyChatWord_Cards[] = _("KARTENSPIELE");
const u8 gEasyChatWord_Shopping[] = _("EINKAUFEN");
const u8 gEasyChatWord_Camera[] = _("FOTOS");
const u8 gEasyChatWord_Viewing[] = _("BESICHTIGUNG");
...
const u8 gEasyChatWord_Diet[] = _("NAHRUNG");
const u8 gEasyChatWord_Treasure[] = _("KOSTBARKEIT");
const u8 gEasyChatWord_Travel[] = _("REISEN");
const u8 gEasyChatWord_Dance[] = _("TANZEN");
const u8 gEasyChatWord_Channel[] = _("WASSERSPORT");
const u8 gEasyChatWord_Making[] = _("HERSTELLUNG");
const u8 gEasyChatWord_Fishing[] = _("ANGELN");
const u8 gEasyChatWord_Date[] = _("VERABREDUNG");
const u8 gEasyChatWord_Design[] = _("DESIGN");
const u8 gEasyChatWord_Locomotive[] = _("LOKOMOTIVEN");
const u8 gEasyChatWord_PlushDoll[] = _("PLÜSCHPUPPEN");
...
const u8 gEasyChatWord_Board[] = _("BRETTSPIELE");
const u8 gEasyChatWord_Ball[] = _("BALL");
const u8 gEasyChatWord_Book[] = _("BÜCHER");
const u8 gEasyChatWord_Festival[] = _("FESTIVALS");
const u8 gEasyChatWord_Comics[] = _("COMICS");
const u8 gEasyChatWord_Holiday[] = _("FERIEN");
const u8 gEasyChatWord_Plans[] = _("ETWAS PLANEN");
const u8 gEasyChatWord_Trendy[] = _("SCHICKIMICKI");
const u8 gEasyChatWord_Vacation[] = _("URLAUB");
